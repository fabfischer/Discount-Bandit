...
abstract class MainStore
{
    ...
    public static function prepare_dom($response, &$document, &$xml): bool
    {
    ...
    {
        return (
            str_contains($responseBody, 'opfcaptcha.amazon')
            || str_contains($responseBody, 'amazon.com/captcha/')
            || str_contains($responseBody, 'id="captchacharacters"')
        );
    }
